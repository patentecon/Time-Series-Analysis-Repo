...
You will receive 60 points for submitting the assignment and a few points for each correct part as shown below.
...
Once you get access to FRED, retrieve Real GDP per Capita between the first quarter of 1970 and the first quarter of 2024.

Show your code below
Make sure to not display your FRED API key, it is a private information.  
